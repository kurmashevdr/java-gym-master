...
void testGetCountTrainingSessions() {
    ...
    Set<CounterCoachSessions> counterCoachSessions = getCounterCoachSessions(counterSessionsForCoach,
            counterSessionsForCoach2);
...
private Set<CounterCoachSessions> getCounterCoachSessions(CounterCoachSessions counterSessionsForCoach,
                                                          CounterCoachSessions counterSessionsForCoach2) {
    Set<CounterCoachSessions> counterCoachSessions = new LinkedHashSet<>();
    counterSessionsForCoach.addSession();
    counterSessionsForCoach.addSession();
    counterSessionsForCoach2.addSession();
